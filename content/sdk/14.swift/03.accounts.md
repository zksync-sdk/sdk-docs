...
There is no separate Ether bridge contract, [Main contract](./03.accounts.md#maincontract) is used instead.
...
| `token`           | `String`                                            | The address of the token. `ETH` by default (optional).                                              |
| `options`         | [`TransactionOption`](./08.types.md#transactionoption) | Transaction's options which may be used to pass l2 `gasLimit`, `gasPrice`, `value`, etc (optional). |
| `paymasterParams` | [`PaymasterParams`](./08.types.md#paymasterparams)     | Paymaster parameters (optional).                                                                    |
...
| Parameter     | Type                                                  | Description                |
| ------------- | ----------------------------------------------------- | -------------------------- |
| `transaction` | [`Deposittransaction`](./08.types.md#deposittransaction) | DepositTransaction struct. |
...
| Parameter     | Type                                                                | Description                       |
| ------------- | ------------------------------------------------------------------- | --------------------------------- |
| `transaction` | [`RequestExecuteTransaction`](./08.types.md#requestexecutetransaction) | RequestExecuteTransaction struct. |
