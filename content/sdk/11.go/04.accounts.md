...
| Parameter | Type                                             | Description    |
| --------- | ------------------------------------------------ | -------------- |
| `opts`    | [`CallOpts`](./types/01.accounts.md#callopts) (optional) | Call options.  |
...
specified L1 bridge (default one or the one defined in `BridgeAddress`). In this case, `ApproveERC20` can be enabled
...
| Parameter | Type                                                      | Description                    |
| --------- | --------------------------------------------------------- |--------------------------------|
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional) | Transaction options.           |
| `tx`      | [`DepositTransaction`](./types/01.accounts.md#deposittransaction) | Deposit transaction parameters.|
...
| --------- | ------------------------------------------------- | ------------------------ |
| `ctx`     | `context.Context`                                 | Context.                 |
| `msg`     | [`DepositCallMsg`](./types/01.accounts.md#depositcallmsg) | Deposit call parameters. |
...
| --------- | ----------------------------------------------------------------------- | --------------------------------------- |
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional)               | Transaction options.                    |
| `tx`      | [`RequestExecuteTransaction`](./types/01.accounts.md#requestexecutetransaction) | Request execute transaction parameters. |
...
| --------- | --------------------------------------------------------------- | -------------------------------- |
| `ctx`     | `context.Context`                                               | Context.                         |
| `msg`     | [`RequestExecuteCallMsg`](./types/01.accounts.md#requestexecutecallmsg) | Request execute call parameters. |
...
::: tip More info
See the [default bridges documentation](https://docs.zksync.io/build/developer-reference/bridging-asset.html#default-bridges)
:::
...
| --------- | --------------------------------------------------------------- | ---------------------------------- |
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional)       | Transaction options.               |
| `tx`      | [`WithdrawalTransaction`](./types/01.accounts.md#withdrawaltransaction) | Withdrawal transaction parameters. |
...
| --------- | ------------------------------------------------------- | --------------------------- |
| `ctx`     | `context.Context`                                       | Context.                    |
| `msg`     | [`WithdrawalCallMsg`](./types/01.accounts.md#withdrawalcallmsg) | Withdrawal call parameters. |
...
| --------- | ----------------------------------------------------------- | -------------------------------- |
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional)   | Transaction options.             |
| `tx`      | [`TransferTransaction`](./types/01.accounts.md#transfertransaction) | Transfer transaction parameters. |
...
| --------- | --------------------------------------------------- | ------------------------- |
| `ctx`     | `context.Context`                                   | Context.                  |
| `msg`     | [`TransferCallMsg`](./types/01.accounts.md#transfercallmsg) | Transfer call parameters. |
...
| ------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`         | `context.Context`                   | Context.                                                                                                                                                                                    |
| `msg`         | [`CallMsg`](./types/01.accounts.md#callmsg) | Contains parameters for contract call using EIP-712 transaction.                                                                                                                            |
...
[EIP-712 transaction](./types/04.types.md#eip712txtype). The only required fields are `Transaction.To` and either
...
| --------- | ------------------------------------------- | ----------------------- |
| `ctx`     | `context.Context`                           | Context.                |
| `tx`      | [`Transaction`](./types/01.accounts.md#transaction) | Transaction parameters. |
...
| Parameter | Type                                                   | Description                     |
| --------- | ------------------------------------------------------ | ------------------------------- |
| `tx`      | [`zkTypes.Transaction712`](./types/04.types.md#eip712txtype) | EIP-712 transaction parameters. |
...
| --------- | --------------------------------------------------------- | ------------------------------- |
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional) | Transaction options.            |
| `tx`      | [`Create2Transaction`](./types/01.accounts.md#create2transaction) | CREATE2 transaction parameters. |
...
| --------- | ------------------------------------------------------- | ------------------------------ |
| `auth`    | [`*TransactOpts`](./types/01.accounts.md#transactopts) (optional) | Transaction options.           |
| `tx`      | [`CreateTransaction`](./types/01.accounts.md#createtransaction) | CREATE transaction parameters. |
...
| Parameter | Type                         | Description |
| --------- | ---------------------------- | ----------- |
| `client`  | [`*clients.Client`](./03.clients.md) | L2 client.  |
