...
| Parameter | Type                                             | Description    |
| --------- | ------------------------------------------------ | -------------- |
| `opts`    | [`CallOpts`](types/accounts#callopts) (optional) | Call options.  |
...
| Parameter | Type                                                      | Description                    |
| --------- | --------------------------------------------------------- |--------------------------------|
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional) | Transaction options.           |
| `tx`      | [`DepositTransaction`](types/accounts#deposittransaction) | Deposit transaction parameters.|
...
| --------- | ------------------------------------------------- | ------------------------ |
| `ctx`     | `context.Context`                                 | Context.                 |
| `msg`     | [`DepositCallMsg`](types/accounts#depositcallmsg) | Deposit call parameters. |
...
| --------- | ----------------------------------------------------------------------- | --------------------------------------- |
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional)               | Transaction options.                    |
| `tx`      | [`RequestExecuteTransaction`](types/accounts#requestexecutetransaction) | Request execute transaction parameters. |
...
| --------- | --------------------------------------------------------------- | -------------------------------- |
| `ctx`     | `context.Context`                                               | Context.                         |
| `msg`     | [`RequestExecuteCallMsg`](types/accounts#requestexecutecallmsg) | Request execute call parameters. |
...
::: tip More info
See the [default bridges documentation](https://docs.zksync.io/build/developer-reference/bridging-asset)
:::
...
| --------- | --------------------------------------------------------------- | ---------------------------------- |
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional)       | Transaction options.               |
| `tx`      | [`WithdrawalTransaction`](types/accounts#withdrawaltransaction) | Withdrawal transaction parameters. |
...
| --------- | ------------------------------------------------------- | --------------------------- |
| `ctx`     | `context.Context`                                       | Context.                    |
| `msg`     | [`WithdrawalCallMsg`](types/accounts#withdrawalcallmsg) | Withdrawal call parameters. |
...
| --------- | ----------------------------------------------------------- | -------------------------------- |
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional)   | Transaction options.             |
| `tx`      | [`TransferTransaction`](types/accounts#transfertransaction) | Transfer transaction parameters. |
...
| --------- | --------------------------------------------------- | ------------------------- |
| `ctx`     | `context.Context`                                   | Context.                  |
| `msg`     | [`TransferCallMsg`](types/accounts#transfercallmsg) | Transfer call parameters. |
...
| ------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`         | `context.Context`                   | Context.                                                                                                                                                                                    |
| `msg`         | [`CallMsg`](types/accounts#callmsg) | Contains parameters for contract call using EIP-712 transaction.                                                                                                                            |
...
[EIP-712 transaction](types/types#transaction712). The only required fields are `Transaction.To` and either
...
| --------- | ------------------------------------------- | ----------------------- |
| `ctx`     | `context.Context`                           | Context.                |
| `tx`      | [`Transaction`](types/accounts#transaction) | Transaction parameters. |
...
| Parameter | Type                                                   | Description                     |
| --------- | ------------------------------------------------------ | ------------------------------- |
| `tx`      | [`zkTypes.Transaction712`](types/types#transaction712) | EIP-712 transaction parameters. |
...
| --------- | --------------------------------------------------------- | ------------------------------- |
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional) | Transaction options.            |
| `tx`      | [`Create2Transaction`](types/accounts#create2transaction) | CREATE2 transaction parameters. |
...
| --------- | ------------------------------------------------------- | ------------------------------ |
| `auth`    | [`*TransactOpts`](types/accounts#transactopts) (optional) | Transaction options.           |
| `tx`      | [`CreateTransaction`](types/accounts#createtransaction) | CREATE transaction parameters. |
...
| Parameter | Type                         | Description |
| --------- | ---------------------------- | ----------- |
| `client`  | [`*clients.Client`](clients) | L2 client.  |
