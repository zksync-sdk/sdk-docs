...
[here](https://docs.zksync.io/zk-stack/concepts/transaction-lifecycle.md#eip-712-0x71).

This document will focus solely on how to pass these arguments to the SDK.

## EIP-712 Metadata

[`EIP712Meta`](types/types#eip712meta) contains EIP-712 transaction metadata.
The following objects contain `EIP712Meta` and provides working with
EIP-712 transactions:

- [`types.CallMsg`](types/types#callmsg)
- [`types.Transaction712`](types/types#transaction712)
- [`accounts.CallMsg`](types/accounts#callmsg)
...
[GetPaymasterParams](./paymaster-utils#getpaymasterparams).
