...
as found in [`Log`](./types/04.types.md#log). The `FilterLogs` method is kept in order to be compatible with `bind.ContractBackend`,
...
contain additional data specific to L2, as found in [`Log`](./types/04.types.md#log). The `SubscribeFilterLogs` method is
...
| `ctx`     | `context.Context`                                                                             | Context.                   |
| `query`   | [`ethereum.FilterQuery`](https://pkg.go.dev/github.com/ethereum/go-ethereum@v1.12.0#FilterQuery) | Filter query parameters.   |
| `ch`      | [`chan<- zkTypes.Log`](./types/04.types.md#log)                                                       | Channel that receives Log. |
...
| ------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`         | `context.Context`                        | Context.                                                                                                                                                                                    |
| `msg`         | [`zkTypes.CallMsg`](./types/04.types.md#callmsg) | Contains parameters for contract call using EIP-712 transaction.                                                                                                                            |
...
| --------- | -------------------------------------------------- | -------------------------------------- |
| `ctx`     | `context.Context`                                  | Context.                               |
| `msg`     | [`TransferCallMsg`](./types/01.accounts.md#transfercallmsg) | Contains parameters for transfer call. |
...
| --------- | ------------------------------------------------------ | ---------------------------------------- |
| `ctx`     | `context.Context`                                      | Context.                                 |
| `msg`     | [`WithdrawalCallMsg`](./types/01.accounts.md#withdrawalcallmsg) | Contains parameters for withdrawal call. |
...
| --------- | ------------------------------------------- | ---------------------------------------------------------------- |
| `ctx`     | `context.Context`                           | Context.                                                         |
| `msg`     | [`zkTypes.CallMsg`](./types/01.accounts.md#callmsg) | Contains parameters for contract call using EIP-712 transaction. |
