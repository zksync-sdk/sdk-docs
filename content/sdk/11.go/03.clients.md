...
| --------- | -------------------------------------------------- | -------------------------------------- |
| `ctx`     | `context.Context`                                  | Context.                               |
| `msg`     | [`TransferCallMsg`](/sdk/types/accounts#transfercallmsg) | Contains parameters for transfer call. |
...
| --------- | ------------------------------------------------------ | ---------------------------------------- |
| `ctx`     | `context.Context`                                      | Context.                                 |
| `msg`     | [`WithdrawalCallMsg`](/sdk/types/accounts#withdrawalcallmsg) | Contains parameters for withdrawal call. |
...
| --------- | ------------------------------------------- | ---------------------------------------------------------------- |
| `ctx`     | `context.Context`                           | Context.                                                         |
| `msg`     | [`zkTypes.CallMsg`](/sdk/types/accounts#callmsg) | Contains parameters for contract call using EIP-712 transaction. |
