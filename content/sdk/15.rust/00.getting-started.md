...
upon the [`ethers`][ethers] library. This section serves as its reference.
...
In this tutorial, we will be using the `localnet` from [Dockerized L1 - L2 Nodes](../../test-and-debug/dockerized-l1-l2-nodes.md).
...
Assets will be withdrawn to the target wallet after the validity proof of the zkSync block with
