...
Deprecated in favor of [L2_BASE_TOKEN_ADDRESS](/sdk/js/ethers/v5/utils#l2-base-token)
::
...
::callout
See also [`undol1tol2alias`](/sdk/js/ethers/v5/utils#undol1tol2alias).
::
...
| `ethSignature?` | [`EthereumSignature`](/sdk/js/ethers/v5/types#ethereumsignature) | ECDSA signature of the transaction. |
...
Called from [`isSignatureCorrect`](/sdk/js/ethers/v5/utils#issignaturecorrect) for non-contract account addresses.
...
::callout
See also [`isMessageSignatureCorrect()`](/sdk/js/ethers/v5/utils#ismessagesignaturecorrect) and
[`isTypedDataSignatureCorrect()`](/sdk/js/ethers/v5/utils#istypeddatasignaturecorrect) to validate signatures.
::

### `isEIP1271SignatureCorrect`

Called from [`isSignatureCorrect`](/sdk/js/ethers/v5/utils#ismessagesignaturecorrect) for contract account
...
::callout
See also [`isMessageSignatureCorrect()`](/sdk/js/ethers/v5/utils#ismessagesignaturecorrect)
and [`isTypedDataSignatureCorrect()`](/sdk/js/ethers/v5/utils#istypeddatasignaturecorrect) to validate signatures.
::
...
Called from [`isMessageSignatureCorrect`](/sdk/js/ethers/v5/utils#ismessagesignaturecorrect)
and [`isTypedDataSignatureCorrect`](/sdk/js/ethers/v5/utils#istypeddatasignaturecorrect). Returns true if
...
::callout
See also [`applyl1tol2alias`](/sdk/js/ethers/v5/utils#applyl1tol2alias).
::
