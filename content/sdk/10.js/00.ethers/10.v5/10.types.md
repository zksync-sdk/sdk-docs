...
::collapsible
  ::field{name="type" type="ApprovalBased"}
...
::collapsible
  ::field{name="Mainnet" type="1"}
  ::
  ::field{name="Ropsten" type="3"}
  ::
  ::field{name="Rinkeby" type="4"}
  ::
  ::field{name="Sepolia" type="6"}
  ::
  ::field{name="localhost" type="9"}
  ::
  ::field{name="EraTestNode" type="10"}
  ::
::
...
Interface representation of priority op response that extends [`TransactionResponse`](/sdk/js/ethers/v5/types#transactionresponse)
...
::collapsible
  ::field{name="Full" type="0"}
  ::
  ::field{name="Rollup" type="1"}
  ::
::
...
::collapsible
  ::field{name="Deque" type="0"}
  ::
  ::field{name="HeapBuffer" type="1"}
  ::
  ::field{name="Heap" type="2"}
  ::
::
...
::collapsible
  ::field{name="NotFound" type="not-found"}
  Transaction not found.
  ::
  ::field{name="Processing" type="processing"}
  Transaction is processing.
  ::
  ::field{name="Committed" type="committed"}
  Transaction has been committed.
  ::
  ::field{name="Finalized" type="finalized"}
