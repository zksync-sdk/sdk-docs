...
- **Provider**: Extends [`ethers.JsonRpcProvider`](https://docs.ethers.org/v5/api/providers/jsonrpc/#about-jsonrpcProvider)
...
Returns an estimated [`Fee`](/sdk/js/ethers/v5/types#fee) for requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/sdk/js/ethers/v5/types#paymasterparams) | Paymaster parameters.                                                                      |
...
Helper function: [toJSON](/sdk/js/ethers/v5/providers#tojson).
...
Returns the user's balance as a `BigNumber` object for an block tag and (optional) token.
