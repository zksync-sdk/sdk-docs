...
| `providerL2?` | [`Provider`](/sdk/js/ethers/v5/providers#provider)                                                         | A ZKsync node provider. Needed for interaction with ZKsync. |
...
| `transaction.paymasterParams?` | [`PaymasterParams`](/sdk/js/ethers/v5/types#paymasterparams) | Paymaster parameters.                                                                      |
...
the [`allowanceL1`](/sdk/js/ethers/v5/accounts#getallowancel1) method.
...
Returns the [parameters](/sdk/js/ethers/v5/types#smartaccountsigner) required for finalizing a withdrawal
from the withdrawal transaction's log on the L1 network.
...
By default, uses [`signPayloadWithECDSA`](/sdk/js/ethers/v5/smart-account-utils#signpayloadwithecdsa)
and [`populateTransactionECDSA`](/sdk/js/ethers/v5/smart-account-utils#populatetransactionecdsa).

#### Inputs

| Parameter  | Type                                                  | Description                                         |
| ---------- | ----------------------------------------------------- | --------------------------------------------------- |
| `signer`   | [`SmartAccountSigner`](/sdk/js/ethers/v5/types#smartaccountsigner) | Contains necessary properties for signing payloads. |
| `provider` | [`Provider`](/sdk/js/ethers/v5/providers#provider)                 | The provider to connect to (optional).              |
...
| Parameter  | Type                                  | Description                                    |
| ---------- | ------------------------------------- | ---------------------------------------------- |
| `provider` | [`Provider`](/sdk/js/ethers/v5/providers#provider) | The provider to connect the `SmartAccount` to. |
...
Populates the transaction `tx` using the provided [`TransactionBuilder`](/sdk/js/ethers/v5/types#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](/sdk/js/ethers/v5/types#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v5/types#transactionrequest) | The transaction that needs to be populated. |
...
Signs the transaction `tx` using the provided [`PayloadSigner`](/sdk/js/ethers/v5/types#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v5/types#transactionrequest) | The transaction that needs to be signed. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v5/types#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](/sdk/js/ethers/v5/types#payloadsigner) function.
...
Signs a typed data using the provided [`PayloadSigner`](/sdk/js/ethers/v5/types#payloadsigner) function.
...
| `provider` | [`Provider`](/sdk/js/ethers/v5/providers#provider) | The provider to connect to. |
