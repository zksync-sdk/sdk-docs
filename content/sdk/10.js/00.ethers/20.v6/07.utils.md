...
The [utilities library](https://github.com/zksync-sdk/zksync-ethers/blob/main/src/utils.ts) contains essential
...
Deprecated in favor of [L2_BASE_TOKEN_ADDRESS](/sdk/js/ethers/v6/utils#l2-base-token)
::
...
Generates a future-proof contract address using salt plus bytecode which allows determination of an
...
```ts
const bytecode =
  "";
...
::callout
See also [`isMessageSignatureCorrect()`](/sdk/js/ethers/v6/utils#ismessagesignaturecorrect) and [`isTypedDataSignatureCorrect()`](/sdk/js/ethers/v6/utils#istypeddatasignaturecorrect)
...
Called from [`isSignatureCorrect`](/sdk/js/ethers/v6/utils#issignaturecorrect) for contract account addresses,
...
Called from [`isMessageSignatureCorrect`](/sdk/js/ethers/v6/utils#ismessagesignaturecorrect) and [`isTypedDataSignatureCorrect()`](/sdk/js/ethers/v6/utils#istypeddatasignaturecorrect).
...
::callout
See also [`applyL1ToL2Alias`](/sdk/js/ethers/v6/utils#apply-l1-to-l2-alias).
::
