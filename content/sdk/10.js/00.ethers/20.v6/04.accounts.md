...
The `zksync-ethers` library provides several classes to facilitate account management and transaction signing on the
ZKsync network. These include:

- `Wallet`: Extends the `ethers.Wallet` with additional ZKsync-specific functionalities.
- `EIP712Signer`: For signing `EIP712`-typed ZKsync transactions.
- `Signer` and `L1Signer`: For integration in browser environments.
- `VoidSigner` and `L1VoidSigner`: Allows an address to be used in any API requiring a `Signer` without actual signing credentials.
- `SmartAccount`: Enhances support for account abstraction with:
  - `ECDSASmartAccount`: Uses a single ECDSA key for signing.
  - `MultisigECDSASmartAccount`: Utilizes multiple ECDSA keys for signing.

## Wallet

### `Wallet`

The `Wallet` class constructor initializes a new wallet instance.
...
| `providerL2?` | [`Provider`](/sdk/js/ethers/v6/providers#provider)                                                | A ZKsync node provider. Needed for interaction with ZKsync (optional). |
...
| `transaction.paymasterParams?` | [`PaymasterParams`](/sdk/js/ethers/v6/types#paymasterparams)                          | Paymaster parameters (optional).                                                                      |
...
| `transaction.approveBaseOverrides?` | [`ethers.Overrides`](https://docs.ethers.org/v6/api/contract/#Overrides) | Transaction's overrides which may be used to pass L1 `gasLimit`, `gasPrice`, `value`, etc (optional).                                                                                                                                  |
...
By default, uses [`signPayloadWithECDSA`](/sdk/js/ethers/v6/smart-account-utils#signpayloadwithecdsa) and [`populateTransactionECDSA`](/sdk/js/ethers/v6/smart-account-utils#populatetransactionecdsa).

#### Inputs

| Parameter   | Type                                                  | Description                                                             |
| ----------- | ----------------------------------------------------- | ----------------------------------------------------------------------- |
| `signer`    | [`SmartAccountSigner`](/sdk/js/ethers/v6/types#smartaccountsigner) | Contains necessary properties for signing payloads.                     |
| `provider?` | [`Provider`](/sdk/js/ethers/v6/providers#provider) or `null`       | The provider to connect to. Can be `null` for offline usage (optional). |
...
| Parameter  | Type                                            | Description                                                                                                      |
| ---------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `provider` | [`Provider`](/sdk/js/ethers/v6/providers#provider) or `null` | The provider to connect the `SmartAccount` to. If `null`, the `SmartAccount` will be detached from any provider. |
...
Populates the transaction `tx` using the provided [`TransactionBuilder`](/sdk/js/ethers/v6/types#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](/sdk/js/ethers/v6/types#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v6/types#transactionrequest) | The transaction that needs to be populated. |
...
Signs the transaction `tx` using the provided [`PayloadSigner`](/sdk/js/ethers/v6/types#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v6/types#transactionrequest) | The transaction that needs to be signed. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/v6/types#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](/sdk/js/ethers/v6/types#payloadsigner) function.
...
Signs a typed data using the provided [`PayloadSigner`](/sdk/js/ethers/v6/types#payloadsigner) function.
...
| `provider` | [`Provider`](/sdk/js/ethers/v6/providers#provider)                                                | The provider to connect to. |
