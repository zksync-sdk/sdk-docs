...
Helper function: [toJSON](/sdk/js/ethers/v6/providers).
...
| `provider?` | [`Provider`](/sdk/js/ethers/v6/providers#provider) or `null`       | The provider to connect to. Can be `null` for offline usage. |
