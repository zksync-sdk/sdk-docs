...
- [`Provider`](/sdk/js/ethers/v5/providers#provider): Supplies the same functionality as
...
- [`Web3Provider`](/sdk/js/ethers/v5/providers#web3provider): Extends the ZKsync
Era [`Provider`](/sdk/js/ethers/v5/providers#provider) class to
make it more compatible
  with Web3 wallets.

::callout{icon="i-heroicons-light-bulb"}
Use the [`Web3Provider`](/sdk/js/ethers/v5/providers#web3provider) for browser integrations.
::
