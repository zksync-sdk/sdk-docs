...
as EIP712 transactions. More details on EIP712 transactions can be found in the [ZKstack transaction lifecycle](https://docs.zksync.io/zk-stack/concepts/transaction-lifecycle.html#eip-712-0x71).
...
::callout{icon="i-heroicons-light-bulb"}
Remember: everything inside `customData` in `overrides` is for ZKsync-specific settings.
::
