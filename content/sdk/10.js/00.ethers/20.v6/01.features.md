...
::card-group
::card{title="Account Abstraction" icon="i-heroicons-puzzle-piece" color="blue"}
zkSync supports account abstraction, allowing accounts to have custom validation logic and enabling paymaster support.
::
::card{title="Deployment Transactions" icon="i-heroicons-paper-airplane" color="blue"}
Contracts on zkSync require bytecode to be passed in a separate field during deployment.
::
::card{title="Fee System" icon="i-heroicons-banknotes" color="blue"}
