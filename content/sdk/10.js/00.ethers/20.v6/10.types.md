...
::collapsible
  ::field{name="None" type="number" defaultValue="0"}
  Used for contracts that are not accounts.
  ::
  ::field{name="Version1" type="number" defaultValue="1"}
...
::collapsible
  ::field{name="Sequential" type="number" defaultValue="0"}
  ...
  ::
  ::field{name="Arbitrary" type="number" defaultValue="1"}
...
::collapsible
  ::field{name="type" type="string" defaultValue="'ApprovalBased'"}
...
::collapsible
  ::field{name="[key: string]" type="BigNumber"}
  ::
::
...
::collapsible
  ...
  Binary representation of block number.
  ::
  ::field{name="string" type="string"}
  Hex representation of block number.
  ::
  ::field{name="committed" type="string"}
  ::
  ::field{name="finalized" type="string"}
  ::
  ::field{name="latest" type="string"}
  ::
  ::field{name="earliest" type="string"}
  ::
  ::field{name="pending" type="string"}
  ::
::
...
::collapsible
  ...
  ::
  ::field{name="createAccount" type="string"}
  ::
::
...
::collapsible
  ::field{name="v" type="number"} - The recovery id.

  ::
  ::field{name="r" type="BytesLike"} - The "r" value of the signature.
  ::
  ::field{name="s" type="BytesLike"} - The "s" value of the signature.
  ::
::
...
::collapsible
  ::field{name="type" type="string" defaultValue="'General'"}
  The type of the paymaster input.
  ::
  ::field{name="innerInput" type="BytesLike"}
  The additional input data.
...
::collapsible
  ::field{name="l1BatchNumber" type="number"} - The batch number on L1.
  ::
::
...
::collapsible
  ::field{name="Mainnet" type="number" defaultValue="1"}
  ::
  ::field{name="Ropsten" type="number" defaultValue="3"}
  ::
  ::field{name="Rinkeby" type="number" defaultValue="4"}
  ::
  ::field{name="Sepolia" type="number" defaultValue="6"}
  ::
  ::field{name="localhost" type="number" defaultValue="9"}
  ::
  ::field{name="EraTestNode" type="number" defaultValue="10"}
  ::
::
...
::collapsible
  ::field{name="ApprovalBasedPaymasterInput" type="ApprovalBasedPaymasterInput"}
  ::
  ::field{name="GeneralPaymasterInput" type="GeneralPaymasterInput"}
  ::
::
...
::collapsible
  ::field{name="Full" type="number" defaultValue="0"}
  ::
  ::field{name="Rollup" type="number" defaultValue="1"}
  ::
::
...
::collapsible
  ::field{name="Deque" type="number" defaultValue="0"}
  ::
  ::field{name="HeapBuffer" type="number" defaultValue="1"}
  ::
  ::field{name="Heap" type="number" defaultValue="2"}
  ::
::
...
::collapsible
  ...
  General information about the L2 transaction.
    ...
    ::
  ::
  ::field{name="execute" type="object"} - Details regarding the execution of the transaction.
...
::collapsible
  ...
  ::
  ::field{name="storageProof" type="Array<object>"}
...
::collapsible
  ::field{name="NotFound" type="string" defaultValue="'not-found'"}
  Transaction not found.
  ::
  ::field{name="Processing" type="string" defaultValue="'processing'"}
  Transaction is processing.
  ::
  ::field{name="Committed" type="string" defaultValue="'committed'"}
  Transaction has been committed.
  ::
  ::field{name="Finalized" type="string" defaultValue="'finalized'"}
