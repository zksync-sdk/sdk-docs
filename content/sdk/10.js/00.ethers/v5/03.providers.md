...
Returns an estimated [`Fee`](./10.types.md#fee) for requested transaction.
...
Calls the [`zks_estimateL1ToL2`](https://docs.zksync.io/build/api.html#zks-estimategasl1tol2) JSON-RPC method.
...
| `paymasterParams?` | [`PaymasterParams`](./10.types.md#paymasterparams) | Paymaster parameters (optional).                                                                      |
...
Calls the [`zks_getAllAccountBalances`](https://docs.zksync.io/build/api.html#zks-getallaccountbalances) JSON-RPC method.
...
Calls the [`zks_getBlockDetails`](https://docs.zksync.io/build/api.html#zks-getblockdetails) JSON-RPC method.
...
Calls the [`zks_getBytecodeByHash`](https://docs.zksync.io/build/api.html#zks-getbytecodebyhash) JSON-RPC method.
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](./10.types.md#network) | Type of zkSync network. `Localhost` _by default_. |
...
Calls the [`zks_getL1BatchDetails`](https://docs.zksync.io/build/api.html#zks-getl1batchdetails) JSON-RPC method.
...
Calls the [`zks_getL1BatchNumber`](https://docs.zksync.io/build/api.html#zks-l1batchnumber) JSON-RPC method.
...
Calls the [`zks_getL2ToL1LogProof`](https://docs.zksync.io/build/api.html#zks-getl2tol1logproof) JSON-RPC method.
...
Calls the [`zks_getMainContract`](https://docs.zksync.io/build/api.html#zks-getmaincontract) JSON-RPC method.
...
Returns Merkle [`proofs`](./10.types.md#storageproof) for one or more storage values at the specified account along
with a Merkle proof of their authenticity.

Calls the [`zks_getProof`](https://docs.zksync.io/build/api.html#zks-getproof) JSON-RPC method.
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/build/api.html#zks-getrawblocktransactions)
JSON-RPC method.
...
Returns the [testnet paymaster](https://docs.zksync.io/build/developer-reference/account-abstraction.html#paymasters)
...
Calls the [`getTransactionDetails`](https://docs.zksync.io/build/api.html#zks-gettransactiondetails) JSON-RPC method.
...
Calls the [`zks_L1ChainId`](https://docs.zksync.io/build/api.html#zks-l1chainid) JSON-RPC method.
...
| Parameter | Type                                                            | Description   |
| --------- | --------------------------------------------------------------- | ------------- |
| `filter`  | [`EventFilter`](./10.types.md#eventfilter) or `Promise<EventFilter>` | Filter query. |
