...
Calls the [`zks_estimateL1ToL2`](https://docs.zksync.io/build/api.md#zks-estimategasl1tol2) JSON-RPC method.
...
Calls the [`zks_getAllAccountBalances`](https://docs.zksync.io/build/api.md#zks-getallaccountbalances) JSON-RPC method.
...
Calls the [`zks_getBlockDetails`](https://docs.zksync.io/build/api.md#zks-getblockdetails) JSON-RPC method.
...
Calls the [`zks_getBytecodeByHash`](https://docs.zksync.io/build/api.md#zks-getbytecodebyhash) JSON-RPC method.
...
Calls the [`zks_getL1BatchBlockRange`](https://docs.zksync.io/build/api.md#zks-getl1batchblockrange) JSON-RPC method.
...
Calls the [`zks_getL1BatchDetails`](https://docs.zksync.io/build/api.md#zks-getl1batchdetails) JSON-RPC method.
...
Calls the [`zks_getL1BatchNumber`](https://docs.zksync.io/build/api.md#zks-l1batchnumber) JSON-RPC method.
...
Calls the [`zks_getL2ToL1LogProof`](https://docs.zksync.io/build/api.md#zks-getl2tol1logproof) JSON-RPC method.
...
Calls the [`zks_getMainContract`](https://docs.zksync.io/build/api.md#zks-getmaincontract) JSON-RPC method.
...
Returns Merkle [`proofs`](./types.md#storageproof) for one or more storage values at the specified account along
with a Merkle proof of their authenticity.

Calls the [`zks_getProof`](https://docs.zksync.io/build/api.md#zks-getproof) JSON-RPC method.
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/build/api.md#zks-getrawblocktransactions)
JSON-RPC method.
...
Returns the [testnet paymaster](https://docs.zksync.io/build/developer-reference/account-abstraction.md#paymasters)
...
Calls the [`getTransactionDetails`](https://docs.zksync.io/build/api.md#zks-gettransactiondetails) JSON-RPC method.
...
Calls the [`zks_L1ChainId`](https://docs.zksync.io/build/api.md#zks-l1chainid) JSON-RPC method.
