...
<!-- TOOD: @itsacoyote fix the to prop -->
...
Called from [`isSignatureCorrect`](#issignaturecorrect) for contract account addresses, the function returns true if
...
and [`isTypedDataSignatureCorrect`](#istypeddatasignaturecorrect). Returns true if account abstraction EIP712
