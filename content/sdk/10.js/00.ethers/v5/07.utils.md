...
| `ethSignature?` | [`EthereumSignature`](./10.types.md#ethereumsignature) | ECDSA signature of the transaction (optional). |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `receipt` | [`TransactionReceipt`](./10.types.md#transactionreceipt) | Transaction receipt. |
...
| Parameter       | Type                                                  | Description                          |
| --------------- | ----------------------------------------------------- | ------------------------------------ |
| `txReceipt`     | [`TransactionReceipt`](./10.types.md#transactionreceipt) | Receipt of the L1 transaction.       |
