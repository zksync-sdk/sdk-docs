...
Returns the [parameters](./types.md#finalizewithdrawalparams) required for finalizing a withdrawal
...
By default, uses [`signPayloadWithECDSA`](./smart-account-utils.md#signpayloadwithecdsa)
and [`populateTransactionECDSA`](./smart-account-utils.md#populatetransactionecdsa).
