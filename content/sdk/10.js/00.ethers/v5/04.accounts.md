...
Returns the [parameters](./10.types.md#smartaccountsigner) required for finalizing a withdrawal
...
By default, uses [`signPayloadWithECDSA`](./09.smart-account-utils.md#signpayloadwithecdsa)
and [`populateTransactionECDSA`](./09.smart-account-utils.md#populatetransactionecdsa).
...
| `provider` | [`Provider`](./03.providers.md#provider)                 | The provider to connect to (optional).              |
...
| Parameter  | Type                                  | Description                                    |
| ---------- | ------------------------------------- | ---------------------------------------------- |
| `provider` | [`Provider`](./03.providers.md#provider) | The provider to connect the `SmartAccount` to. |
