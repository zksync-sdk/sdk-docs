...
::callout
See also [`undol1tol2alias`](/sdk/js/ethers/api/v5/utilities/utils#undol1tol2alias).
::
...
| `ethSignature?` | [`EthereumSignature`](/sdk/js/ethers/api/v5/types#ethereumsignature) | ECDSA signature of the transaction. |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `receipt` | [`TransactionReceipt`](/sdk/js/ethers/api/v5/types#transactionreceipt) | Transaction receipt. |
...
| Parameter       | Type                                                  | Description                          |
| --------------- | ----------------------------------------------------- | ------------------------------------ |
| `txReceipt`     | [`TransactionReceipt`](/sdk/js/ethers/api/v5/types#transactionreceipt) | Receipt of the L1 transaction.       |
