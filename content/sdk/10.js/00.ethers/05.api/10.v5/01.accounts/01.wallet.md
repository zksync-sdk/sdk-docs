...
| `providerL2?` | [`Provider`](/sdk/js/ethers/api/v5/providers/provider)                                                         | A ZKsync node provider. Needed for interaction with ZKsync. |
...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/sdk/js/ethers/api/v5/providers/provider) | A ZKsync node provider. |
