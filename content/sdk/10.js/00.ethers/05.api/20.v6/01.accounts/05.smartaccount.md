...
| `provider?` | [`Provider`](/sdk/js/ethers/api/v6/provider/providers) or `null`       | The provider to connect to. Can be `null` for offline usage. |
...
| Parameter  | Type                                            | Description                                                                                                      |
| ---------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `provider` | [`Provider`](/sdk/js/ethers/api/v6/provider/providers) or `null` | The provider to connect the `SmartAccount` to. If `null`, the `SmartAccount` will be detached from any provider. |
...
| `provider` | [`Provider`](/sdk/js/ethers/api/v6/provider/providers)                                                | The provider to connect to. |
