...
| `providerL2?` | [`Provider`](/sdk/js/ethers/api/v6/provider/providers)                                                | A ZKsync node provider. Needed for interaction with ZKsync. |
...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/sdk/js/ethers/api/v6/provider/providers) | A ZKsync node provider. |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `tx`      | [`TransactionRequest`](/sdk/js/ethers/api/v6/types#transactionrequest) | Transaction request. |
...
use the [`allowanceL1`](/sdk/js/ethers/api/v6/accounts/wallet#getallowancel1) method.
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/sdk/js/ethers/api/v6/types#fulldepositfee).
...
Returns the [parameters](/sdk/js/ethers/api/v6/types#finalizewithdrawalparams) required for
...
Helper function: [toJSON](/sdk/js/ethers/api/v6/provider/browser-provider#tojson).
