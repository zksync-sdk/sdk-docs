...
Returns an estimated [`Fee`](/sdk/js/ethers/api/v6/types#fee) for the requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/sdk/js/ethers/api/v6/types#paymasterparams)              | Paymaster parameters.  |
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/sdk/js/ethers/api/v6/types#network) | Type of ZKsync network. `Localhost` _by default_. |
...
Returns Merkle [`proofs`](/sdk/js/ethers/api/v6/types#storageproof) for one or more storage values at the
