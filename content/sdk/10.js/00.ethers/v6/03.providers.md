...
Returns Merkle [`proofs`](./10.types.md#storageproof) for one or more storage values at the
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/build/api.html#zks-getrawblocktransactions) JSON-RPC method.
...
Calls the [`zks_getTransactionDetails`](https://docs.zksync.io/build/api.html#zks-gettransactiondetails) JSON-RPC method.
