...
Returns Merkle [`proofs`](./types.md#storageproof) for one or more storage values at the
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/build/api.md#zks-getrawblocktransactions) JSON-RPC method.
...
Calls the [`zks_getTransactionDetails`](https://docs.zksync.io/build/api.md#zks-gettransactiondetails) JSON-RPC method.
