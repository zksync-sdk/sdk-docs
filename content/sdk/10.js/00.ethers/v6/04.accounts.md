...
| `providerL2?` | [`Provider`](./03.providers.md#provider)                                                | A zkSync node provider. Needed for interaction with zkSync (optional). |
...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](./03.providers.md#provider) | A zkSync node provider. |
...
| Parameter     | Type                                                  | Description          |
| ------------- | ----------------------------------------------------- | -------------------- |
| `transaction` | [`TransactionRequest`](./10.types.md#transactionrequest) | Transaction request. |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `tx`      | [`TransactionRequest`](./10.types.md#transactionrequest) | Transaction request. |
...
| `transaction.paymasterParams?` | [`PaymasterParams`](./10.types.md#paymasterparams)                          | Paymaster parameters (optional).                                                                      |
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](./10.types.md#fulldepositfee).
...
Returns the [parameters](./10.types.md#finalizewithdrawalparams) required for finalizing a withdrawal
...
Returns the [parameters](./10.types.md#finalizewithdrawalparams) required for finalizing a withdrawal from the withdrawal
...
By default, uses [`signPayloadWithECDSA`](./09.smart-account-utils.md#signpayloadwithecdsa) and [`populateTransactionECDSA`](./09.smart-account-utils.md#populatetransactionecdsa).

#### Inputs

| Parameter   | Type                                                  | Description                                                             |
| ----------- | ----------------------------------------------------- | ----------------------------------------------------------------------- |
| `signer`    | [`SmartAccountSigner`](./10.types.md#smartaccountsigner) | Contains necessary properties for signing payloads.                     |
| `provider?` | [`Provider`](./03.providers.md#provider) or `null`       | The provider to connect to. Can be `null` for offline usage (optional). |
...
| Parameter  | Type                                            | Description                                                                                                      |
| ---------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `provider` | [`Provider`](./03.providers.md#provider) or `null` | The provider to connect the `SmartAccount` to. If `null`, the `SmartAccount` will be detached from any provider. |
...
Populates the transaction `tx` using the provided [`TransactionBuilder`](./10.types.md#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](./10.types.md#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](./10.types.md#transactionrequest) | The transaction that needs to be populated. |
...
Signs the transaction `tx` using the provided [`PayloadSigner`](./10.types.md#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](./10.types.md#transactionrequest) | The transaction that needs to be signed. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](./10.types.md#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](./10.types.md#payloadsigner) function.
...
Signs a typed data using the provided [`PayloadSigner`](./10.types.md#payloadsigner) function.
...
| `provider` | [`Provider`](./03.providers.md#provider)                                                | The provider to connect to. |
