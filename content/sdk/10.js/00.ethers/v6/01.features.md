...
[here](https://docs.zksync.io/build/zk-stack/concepts/transaction-lifecycle.md#eip-712-0x71).
...
object: [getPaymasterParams](./paymaster-utils.md#getpaymasterparams).
...
You can also check out our [tutorial](https://docs.zksync.io/build/quick-start/hello-world.md)
