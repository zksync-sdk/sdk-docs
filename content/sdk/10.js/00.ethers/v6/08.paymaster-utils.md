...
| ---------------- | ----------------------------------------------------------------------- | -------------------------------- |
| `paymasterInput` | [`ApprovalBasedPaymasterInput`](./10.types.md#approvalbasedpaymasterinput) | The input data to the paymaster. |
...
| Parameter        | Type                                                        | Description                      |
| ---------------- | ----------------------------------------------------------- | -------------------------------- |
| `paymasterInput` | [`GeneralPaymasterInput`](./10.types.md#generalpaymasterinput) | The input data to the paymaster. |
...
| `paymasterInput`   | [`PaymasterInput`](./10.types.md#paymasterinput) | The input data to the paymaster.  |

```ts
function getPaymasterParams(paymasterAddress: Address, paymasterInput: PaymasterInput): PaymasterParams;
```

Find out more about the [`PaymasterInput` type](./10.types.md).
