...
Returns an estimated [`Fee`](./08.types.md#fee) for requested transaction.

#### Inputs

| Parameter     | Type                                    | Description          |
| ------------- | --------------------------------------- | -------------------- |
| `transaction` | [`Transaction`](./08.types.md#transaction) | Transaction request. |
...
| Parameter     | Type                                    | Description               |
| ------------- | --------------------------------------- | ------------------------- |
| `transaction` | [`Transaction`](./08.types.md#transaction) | Transaction.              |
...
| Parameter     | Type                                    |
| ------------- | --------------------------------------- |
| `Transaction` | [`Transaction`](./08.types.md#transaction) |
...
Returns [`BlockDetails`](./08.types.md#blockdetails) additional zkSync-specific information about the L2 block.
...
Returns [`ContractAccountInfo`](./08.types.md#contractaccountinfo) class with version of the supported account
...
Returns [`BridgeAddresses`](./08.types.md#bridgeaddresses) class containing addresses of the default zkSync Era
...
Calls the [`zks_getL2ToL1MsgProof`](https://docs.zksync.io/build/api.html#zks-getl2tol1msgproof) JSON-RPC method.
...
Returns the [testnet paymaster](https://docs.zksync.io/build/quick-start/useful-address.html#sepolia-contract-addresses)
