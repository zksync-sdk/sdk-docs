...
Returns [`ContractAccountInfo`](types.md#accountabstractionversion) class with version of the supported account
...
Returns [`BridgeAddresses`](types.md#bridgeaddresses) class containing addresses of the default zkSync Era
...
Calls the [`zks_getL2ToL1MsgProof`](https://docs.zksync.io/build/api.md#zks-getl2tol1msgproof) JSON-RPC method.
...
Returns the [testnet paymaster](.https://docs.zksync.io/build/quick-start/useful-address.md#sepolia-contract-addresses)
