...
These examples demonstrate how to deploy contracts on the ZKsync Era network using both `create` and `create2`
methods. Make sure to replace `"ZKSYNC_NETWORK_URL"` and other placeholder values with your actual configuration
details.
