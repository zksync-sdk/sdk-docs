...
In this case, depending on is the chain ETH-based or not `transaction.approve_erc20` or `transaction.approve_base_erc20`If there are already enough approved tokens for the L1 bridge, token approval will be skipped.
