...
| Name    | Description                                                 |
| ------- | ----------------------------------------------------------- |
| returns | [`L1BridgeContracts`](/python/types#l1bridgecontracts) object. |
...
| Name    | Description                                              |
| ------- | -------------------------------------------------------- |
| tx      | [`TransferTransaction`](/python/types#transfertransaction). |
...
In this case, `transaction.approve_erc20` can be enabled to perform token approval.
...
| Name        | Description                                           |
| ----------- | ----------------------------------------------------- |
| transaction | [`Deposittransaction`](/python/types#deposittransaction) |
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/python/types#fulldepositfee).
...
| Name        | Description                                             |
| ----------- | ------------------------------------------------------- |
| transaction | [`WithdrawTransaction`](/python/types#withdrawtransaction) |
...
| Name        | Description                                                        |
| ----------- | ------------------------------------------------------------------ |
| transaction | [`RequestExecuteCallMsg`](/python/types#requestexecutecallmsg) object |
