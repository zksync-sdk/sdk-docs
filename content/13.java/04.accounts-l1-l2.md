...
This section explores the methods which allow the [account](/java/accounts) to send transactions
...
For more information, please refer to the method specification [`Deposit`](/java/accounts#deposit).
...
For more information, please refer to the method specification [`requestExecute`](/java/accounts#requestexecute).

## Base cost

`Wallet` and `L1Signer` objects provide an option to calculate base cost for L2 transaction.
For more information, please refer to the method specification [`getBaseCost`](/java/accounts#getbasecost).
