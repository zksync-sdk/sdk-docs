...
| Parameter | Type                                                           | Description                     |
| --------- |----------------------------------------------------------------| ------------------------------- |
| `tx`      | [`zkTypes.Transaction712`](/go/api/types#transaction712) | EIP-712 transaction parameters. |
...
[EIP-712 transaction](/go/api/types#transaction712). The only required fields are `Transaction.To` and either
