...
Returns an estimated [`Fee`](/js/ethers/v5/types#fee) for requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/js/ethers/v5/types#paymasterparams) | Paymaster parameters (optional).                                                                      |
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/js/ethers/v5/types#network) | Type of zkSync network. `Localhost` _by default_. |
...
<!-- Calls the [`zks_getL1BatchBlockRange`](https://docs.zksync.io/build/api.html#zks-getl1batchblockrange)
JSON-RPC method. -->
...
Returns Merkle [`proofs`](/js/ethers/v5/types#storageproof) for one or more storage values at the specified account along
...
| Parameter | Type                                                            | Description   |
| --------- | --------------------------------------------------------------- | ------------- |
| `filter`  | [`EventFilter`](/js/ethers/v5/types#eventfilter) or `Promise<EventFilter>` | Filter query. |
