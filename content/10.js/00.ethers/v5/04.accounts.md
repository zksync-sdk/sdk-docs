...
| `providerL2?` | [`Provider`](/js/ethers/v5/providers#provider)                                                         | A zkSync node provider. Needed for interaction with zkSync (optional). |
...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/js/ethers/v5/providers#provider) | A zkSync node provider. |
...
| Parameter     | Type                                                  | Description          |
| ------------- | ----------------------------------------------------- | -------------------- |
| `transaction` | [`TransactionRequest`](/js/ethers/v5/types#transactionrequest) | Transaction request. |
...
| `transaction.paymasterParams?` | [`PaymasterParams`](/js/ethers/v5/types#paymasterparams) | Paymaster parameters (optional).                                                                      |
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/js/ethers/v5/types#fulldepositfee).
...
Returns the [parameters](/js/ethers/v5/types#finalizewithdrawalparams) required for finalizing a withdrawal from the withdrawal
...
Returns the [parameters](/js/ethers/v5/types#smartaccountsigner) required for finalizing a withdrawal
...
By default, uses [`signPayloadWithECDSA`](/js/ethers/v5/smart-account-utils#signpayloadwithecdsa)
and [`populateTransactionECDSA`](/js/ethers/v5/smart-account-utils#populatetransactionecdsa).

#### Inputs

| Parameter  | Type                                                  | Description                                         |
| ---------- | ----------------------------------------------------- | --------------------------------------------------- |
| `signer`   | [`SmartAccountSigner`](/js/ethers/v5/types#smartaccountsigner) | Contains necessary properties for signing payloads. |
| `provider` | [`Provider`](/js/ethers/v5/providers#provider)                 | The provider to connect to (optional).              |
...
| Parameter  | Type                                  | Description                                    |
| ---------- | ------------------------------------- | ---------------------------------------------- |
| `provider` | [`Provider`](/js/ethers/v5/providers#provider) | The provider to connect the `SmartAccount` to. |
...
Populates the transaction `tx` using the provided [`TransactionBuilder`](/js/ethers/v5/types#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](/js/ethers/v5/types#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](/js/ethers/v5/types#transactionrequest) | The transaction that needs to be populated. |
...
Signs the transaction `tx` using the provided [`PayloadSigner`](/js/ethers/v5/types#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](/js/ethers/v5/types#transactionrequest) | The transaction that needs to be signed. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](/js/ethers/v5/types#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](/js/ethers/v5/types#payloadsigner) function.
...
Signs a typed data using the provided [`PayloadSigner`](/js/ethers/v5/types#payloadsigner) function.
...
| `provider` | [`Provider`](/js/ethers/v5/providers#provider) | The provider to connect to. |
