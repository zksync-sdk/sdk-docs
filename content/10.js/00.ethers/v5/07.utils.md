...
| `ethSignature?` | [`EthereumSignature`](/js/ethers/v5/types#ethereumsignature) | ECDSA signature of the transaction (optional). |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `receipt` | [`TransactionReceipt`](/js/ethers/v5/types#transactionreceipt) | Transaction receipt. |
...
| Parameter       | Type                                                  | Description                          |
| --------------- | ----------------------------------------------------- | ------------------------------------ |
| `txReceipt`     | [`TransactionReceipt`](/js/ethers/v5/types#transactionreceipt) | Receipt of the L1 transaction.       |
