...
Get the network (helper function [toJSON](/js/ethers/v5/providers#tojson)):
...
Get the block by hash (helper function [toJSON](/js/ethers/v5/providers#tojson)):

```ts
console.log(`Block: ${toJSON(await provider.getBlock("b472c070c9e121ba42702f6c322b7b266e287a4d8b5fa426ed265b105430c397", true))}`);
```

Get the transaction by hash (helper function [toJSON](/js/ethers/v5/providers#tojson)):
