...
Returns an estimated [`Fee`](/js/ethers/v6/types#fee) for requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/js/ethers/v6/types#paymasterparams)                          | Paymaster parameters (optional).    |
...
Calls the [`zks_getAllAccountBalances`](https://docs.zksync.io/build/api-reference/zks-rpc#zks_getallaccountbalances) JSON-RPC method.
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/js/ethers/v6/types#network) | Type of zkSync network. `Localhost` _by default_. |
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/build/api-reference/zks-rpc#zks_getrawblocktransactions) JSON-RPC method.
...
Calls the [`zks_getTransactionDetails`](https://docs.zksync.io/build/api-reference/zks-rpc#zks_gettransactiondetails) JSON-RPC method.
