...
| Parameter       | Type                                                                   | Description                                    |
| --------------- | ---------------------------------------------------------------------- | ---------------------------------------------- |
| `transaction`   | `Transaction` or [`TransactionRequest`](/js/ethers/v6/types#transactionrequest) | EIP-712 transaction.                           |
| `ethSignature?` | [`EthereumSignature`](/js/ethers/v6/types#ethereumsignature)                    | ECDSA signature of the transaction (optional). |
