...
as found in [`Log`](/go/types/types#log). The `FilterLogs` method is kept in order to be compatible with `bind.ContractBackend`,
...
contain additional data specific to L2, as found in [`Log`](/go/types/types#log). The `SubscribeFilterLogs` method is
...
| `ctx`     | `context.Context`                                                                             | Context.                   |
| `query`   | [`ethereum.FilterQuery`](https://pkg.go.dev/github.com/ethereum/go-ethereum@v1.12.0#FilterQuery) | Filter query parameters.   |
| `ch`      | [`chan<- zkTypes.Log`](/go/types/types#log)                                                       | Channel that receives Log. |
...
| ------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ctx`         | `context.Context`                        | Context.                                                                                                                                                                                    |
| `msg`         | [`zkTypes.CallMsg`](/go/types/types#callmsg) | Contains parameters for contract call using EIP-712 transaction.                                                                                                                            |
...
| --------- | -------------------------------------------------- | -------------------------------------- |
| `ctx`     | `context.Context`                                  | Context.                               |
| `msg`     | [`TransferCallMsg`](/go/types/accounts#transfercallmsg) | Contains parameters for transfer call. |
...
| --------- | ------------------------------------------------------ | ---------------------------------------- |
| `ctx`     | `context.Context`                                      | Context.                                 |
| `msg`     | [`WithdrawalCallMsg`](/go/types/accounts#withdrawalcallmsg) | Contains parameters for withdrawal call. |
...
| --------- | ------------------------------------------- | ---------------------------------------------------------------- |
| `ctx`     | `context.Context`                           | Context.                                                         |
| `msg`     | [`zkTypes.CallMsg`](/go/types/accounts#callmsg) | Contains parameters for contract call using EIP-712 transaction. |
