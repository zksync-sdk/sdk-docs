...
[`EIP712Meta`](./types/04.types.md#eip712meta) contains EIP-712 transaction metadata.
The following objects contain `EIP712Meta` and provides working with
EIP-712 transactions:

- [`types.CallMsg`](./types/04.types.md#callmsg)
- [`types.Transaction712`](./types/04.types.md#transaction712)
- [`accounts.CallMsg`](./types/04.types.md#callmsg)
- [`accounts.Transaction`](./types/04.types.md#transactiondetails)
...
[GetPaymasterParams](./07.paymaster-utils.md#getpaymasterparams).
